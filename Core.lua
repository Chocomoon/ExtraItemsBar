...
function EIB:PrintHelp()
	EIB:Print(L["SLASH_OPEN"] or "/eib - open options")
	EIB:Print(L["SLASH_UNLOCK"] or "/eib unlock - toggle drag mode")
	EIB:Print(L["SLASH_RESET"] or "/eib reset - reset bar positions")
end
