-- Extra Items Bar - item data tables.
-- Derived from ElvUI_WindTools Modules/Item/ExtraItemBar_Data.lua (fang2hou).
-- Game data (item ID tables) is copied verbatim. See NOTICE.txt for attribution.
...
EB.StateFetcher = {
	...
	[EB.STATE.QUANTUM_ITEM_ALLOWED] = function()
		return not EIB.db.profile.extraItemsBar.noQuantumItems
	end,
}
...
local openableItems = {
	...
	-- https://www.wowhead.com/items/consumables/other?filter=166:11;12:1;0:0
	238531, -- 光耀胃囊
	239077, -- 意义不明的肉坨
	242650, -- 一箱岩石 (1)
	245644, -- 一箱岩石 (2)
	...
	245651, -- 草药花束 (2)
	246585, -- 工匠商盟支出
	246751, -- 装满勇士曙光纹章的凯旋背包
	246752, -- 装满英雄曙光纹章的庆祝礼包
	246753, -- 一簇辉煌的神话曙光纹章
	246754, -- 一袋老兵曙光纹章
	246755, -- 装满勇士曙光纹章的背包
	246756, -- 装满英雄曙光纹章的礼包
	...
	269704, -- 胜利的斯托玛兰宝箱
	270431, -- 哈籁尼尔手提箱
	274069, -- 装满英雄曙光纹章的战团绑定礼包
	274070, -- 装满勇士曙光纹章的战团绑定礼包
	274071, -- 装满老兵曙光纹章的战团绑定礼包
	279522, -- 盈余的派对礼品袋
	279523, -- 满溢的丰饶背包
	279525, -- 好学者的补给包
	279526, -- 胜利的斯托玛兰巅峰之箱

	-- 12.0.5 新增 (https://www.wowhead.com/tw/items/consumables/other?filter=82:11;2:1;120005:0)
	264914, -- 遊俠儲物箱
	270244, -- 戰場小包
	270247, -- 戰場背袋
	270932, -- 扭動的戰場小包
...
local professionItems = {
	...
	mn = {
		...
		-- https://www.wowhead.com/items/miscellaneous/other?filter=107;0;Study+to+increase+your+Midnight
		237496, -- 火成岩样本
		237506, -- 龟裂的结核
		237507, -- 浑浊的石英
		238465, -- 萨拉斯凤羽
...
EB.ModuleList = {
	...
	["FISHINGTWW"] = CreateList(fishings, "general", "tww"),
	["FISHINGMN"] = CreateList(fishings, "general", "mn"),
	["BANNER"] = banners,
	["UTILITY"] = utilities,
	["OPENABLE"] = openableItems,
	["PROF"] = CreateList(professionItems, "tww", "mn"),
	["PROFTWW"] = CreateList(professionItems, "tww"),
	["PROFMN"] = CreateList(professionItems, "mn"),
	["SEEDS"] = seeds,
	["BIGDIG"] = bigDig,
	["DELVE"] = delveItem,
